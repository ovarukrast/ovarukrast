...
const FillInTheBlank: React.FC<FillInTheBlankProps> = ({ exercise, onFinish }) => {
                        ...
                        <div key={index}>
                            <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4">
                                <p className="text-lg text-slate-700 mb-2 sm:mb-0 flex-grow">
                                    {index + 1}. {q.sentence.split('___')[0]}
                                    <input
                                        type="text"
                                        value={answers[index] || ''}
                                ...
                                {q.hintInGreek && <p className="text-sm text-slate-500 self-start sm:self-center">(Pista: {q.hintInGreek})</p>}
                                {submitted && (
